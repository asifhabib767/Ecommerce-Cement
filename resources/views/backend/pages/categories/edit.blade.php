                                ...
                                <div class="form-group">
                                    ...
                                    <select class="parent_categories_select form-control custom-select " id="parent_categories" name="parent_category_id" style="width: 100%;">
                                        ...
                                        @foreach ($parent_categories as $categoryParent)
                                            <option value="{{ $categoryParent->id }}" {{ $category->parent_category_id === $categoryParent->id ? 'selected' : null }}>{{ $categoryParent->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 enable_bg_area {{ $category->enable_bg ? 'display-block' : 'display-hidden' }}">
                                        <div class="form-group">
