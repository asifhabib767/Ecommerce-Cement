...
namespace App\Http\Controllers\Backend\Modules\Product;
...
class ProductsController extends Controller
{
    ...
    public function index($isTrashed = false)
    {
        ...
        if (request()->ajax()) {
            if ($isTrashed) {
                $products = Product::leftjoin('vendors', 'products.vendor_id', '=', 'vendors.id')
            ...
            $datatable = DataTables::of($products, $isTrashed)
                        ...
                        if ($row->deleted_at === null) {
                            ...
                            $html .= '<div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item waves-effect waves-light" title="Show Product Details" href="' . route('admin.products.show', $row->id) . '"><i class="fa fa-eye">Show</i></a>
                                            <a class="dropdown-item waves-effect waves-light" title="Edit Product" href="' . route('admin.products.edit', $row->id) . '"><i class="fa fa-edit">Edit</i></a>
                                            <a class="dropdown-item waves-effect waves-light" title="Delete Product" id="deleteItem' . $row->id . '"data-toggle="modal"><i class="fa fa-trash">Delete</i></a>
                                            <a class="dropdown-item waves-effect waves-light" title="Product Stock&Price Update"  href="' . route('admin.stock-price', $row->id) . '"><i class="fa fa-check">Product Stock&Price Update</i></a>
                                        </div>
                                     </div> ';
                        } else {
                ...
                ->editColumn('name', function ($row) {
                    return $row->name . ' <br /><a href="' . route('pages.show', $row->id) . '" target="_blank"><i class="fa fa-link"></i> View</a>';
                })
